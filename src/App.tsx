...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 will-change-auto ${
        scrolled ? "bg-white/80 backdrop-blur-md py-2" : "bg-transparent py-3"
      }`}
    >
      <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
        <a href="#" className="text-xl font-bold tracking-tight group">
          <span
            className="inline-block transition-transform group-hover:-rotate-3"
            style={{ fontFamily: "Syne, sans-serif" }}
          >
            Drizzle
          </span>
          <span
            className="inline-block transition-transform group-hover:rotate-3 text-gradient"
            style={{
        ...
        <div className="hidden md:flex gap-8 text-sm font-medium">
          {["Work", "About", "Services", "Contact"].map((item, i) => (
            ...
            >
              <span className="inline-block transition-transform group-hover:-translate-y-full">
                {item}
              </span>
              <span className="absolute left-0 top-0 inline-block translate-y-full transition-transform group-hover:translate-y-0 text-gradient font-semibold">
                {item}
              </span>
            </a>
          ))}
...
const FloatingOrb = ({
  ...
  <div
    className={`absolute rounded-full blur-3xl opacity-30 animate-float will-change-transform transform-gpu ${className}`}
...
const Hero = () => {
  ...
  return (
    <section
      ref={heroRef}
      id="hero"
      className="min-h-[100dvh] flex flex-col justify-center pt-16 px-6 relative overflow-hidden"
    >
      {/* Animated background orbs */}
      <FloatingOrb
        className="w-96 h-96 bg-purple-300 -top-20 -left-20"
        delay={0}
      />
      <FloatingOrb
        className="w-80 h-80 bg-blue-300 top-1/3 -right-20"
        delay={2}
      />
      <FloatingOrb
        className="w-64 h-64 bg-amber-200 bottom-20 left-1/4"
        delay={4}
      />
      ...
      <div className="max-w-6xl w-full mx-auto space-y-5 relative z-10">
        ...
        <h1
          className="text-[3.4rem] sm:text-[4.3rem] lg:text-[5.1rem] font-bold tracking-tight leading-[1.1] text-black animate-slide-up"
          style={{ fontFamily: "Syne, sans-serif" }}
        >
        ...
        <p
          className="block text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl animate-fade-in-up"
          style={{ animationDelay: "0.4s" }}
        >
          Through educational X threads, project breakdowns, and long-form
          writing.
        </p>
        <div
...
const ProjectCard = ({
  ...
  >
    ...
    <div className="flex justify-between items-start gap-4">
      <div>
        <h3
          className="text-xl font-semibold tracking-tight mb-1 group-hover:text-purple-600 transition-colors"
          style={{ fontFamily: "Syne, sans-serif" }}
        >
          {title}
        </h3>
      ...
      <div className="w-8 h-8 shrink-0 rounded-full bg-gray-100 flex items-center justify-center group-hover:bg-black group-hover:text-white transition-all">
        <svg
          className="w-3 h-3 transition-transform group-hover:rotate-45"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
...
const ProofOfWork = () => {
  const xThreads = [
    {
      title: "The Growth Toolkit Your Product Needs",
      category: "X Thread",
      link: "https://x.com/i/status/1818700607751905765",
      image: "/20260115_130416.jpg",
    },
    {
      title: "Solana ID and Identity Layers in Web3",
      category: "X Thread",
      link: "https://x.com/i/status/1831274889656914321",
      image: "/20260115_130407.jpg",
    },
    {
      title: "Neon EVM (Solana Network Extension)",
      category: "X Thread",
      link: "https://x.com/i/status/1864736731301372224",
      image: "/20260115_130743.jpg",
    },
  ];

  const articles = [
    {
      title: "How to Easily Distribute Tokens with Smithii's Airdrop Tool",
      category: "How-to Guide",
      link: "https://medium.com/@drizzleshine/how-to-easily-distribute-tokens-with-smithiis-airdrop-tool-part-1-bf8bbd2e204d",
      image: "/smithe.png",
    },
    {
      title: "I Can Prove I'm Real and Still Earn Rewards on Solana",
      category: "Project Breakdown",
      link: "https://medium.com/@drizzleshine/i-can-prove-im-real-and-still-earn-rewards-on-solana-without-giving-away-my-privacy-b633211bf8ff",
      image: "/SID.png",
    },
  ];

  return (
    <section id="work" className="py-16 md:py-32 px-6 relative">
      <div className="absolute inset-0 bg-linear-to-b from-transparent via-purple-50/30 to-transparent" />
      <div className="max-w-6xl mx-auto relative">
        <div className="mb-16 text-center">
          <p className="text-sm font-medium text-gradient tracking-wide uppercase mb-3">
            Proof of Work
          </p>
          <h2
        ...
        <div className="mb-20">
          <h3 className="text-lg font-semibold mb-8 text-gray-600 flex items-center gap-3">
            <span className="w-8 h-px bg-gray-300" />X / Twitter Threads
          </h3>
...
const About = () => {
  return (
    <section
      id="about"
      className="py-16 md:py-32 px-6 bg-white relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="space-y-6 text-lg text-gray-600 leading-relaxed mb-16 max-w-2xl mx-auto text-center">
          <p>
            I write about Web3 and decentralized finance, with the goal of
            making complex ideas easier to understand — especially for people
            encountering them for the first time.
          </p>
          <p>
            My work spans educational X threads, project breakdowns, and
            long-form articles. I care deeply about structure, flow, and helping
            the reader walk away actually understanding something.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 pt-8 border-t border-gray-100">
          <StatCounter value="2023" label="Started" />
          <StatCounter value="7" suffix="+" label="Clients" />
          <StatCounter value="3" label="Grants Won" />
  ...
  const services = [
    {
      ...
      description:
        "Simplify Web3 and DeFi concepts into engaging, digestible threads that educate and build trust with your audience.",
      icon: "💬",
    ...
    },
    {
      ...
      description:
        "Deep-dive analysis that explains your product's use case, value proposition, and technical details in clear language.",
      icon: "📊",
    ...
    },
    {
      ...
      description:
        "I’m open to community support and moderation roles for Web3 and DeFi projects, especially where education and clarity are important.",
      icon: "🤝",
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="relative">
                <div
                  className={`w-14 h-14 rounded-2xl bg-linear-to-br ${service.iconBg} flex items-center justify-center mb-6 text-xl group-hover:scale-110 group-hover:rotate-6 transition-all shadow-lg text-white`}
                >
                  {service.icon}
                </div>
                <h3
                ...
                <a
                  href="#contact"
                  className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-black transition-colors group/link"
                >
                  Get in Touch
                  <svg
...
const Contact = () => {
  return (
    <section
      id="contact"
      className="py-16 md:py-32 px-4 md:px-6 bg-linear-to-br from-purple-600 via-pink-500 to-orange-400 text-white relative overflow-hidden"
    >
      {/* Grid pattern - GPU accelerated to prevent scroll stutter */}
      ...
      <FloatingOrb
        className="w-96 h-96 bg-white -top-40 -left-40 opacity-10"
        delay={0}
      />
      <FloatingOrb
        className="w-80 h-80 bg-white bottom-0 -right-40 opacity-10"
        delay={2}
      />
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        ...
        <button
          className="group inline-flex items-center justify-center gap-2 md:gap-3 text-lg sm:text-2xl md:text-3xl font-bold bg-white/10 backdrop-blur-sm px-6 py-3 md:px-8 md:py-4 rounded-full hover:bg-white/20 transition-all hover:scale-105 active:scale-95 max-w-full"
          data-tally-open="dW0vpz"
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-12">
          ...
          <a
            href="mailto:drizzzleshine@gmail.com"
            className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all hover:scale-105"
          >
            Email
          </a>
